	...
	<form action="{{$url}}" method="post">
		 ...
		 <div class="row">
		 	...
		 	<input type="text" readonly  class="form-control" value="{{$tvettraining->servicenumber}}">
		 ...
		 <div class="col-md-12 form-group">
		 	<label>Reason</label>
		 	<textarea name="reason" class="form-control" required>{{$tvettraining->reason}}</textarea>
