    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit System Role Details</h3>
        ...
        <div class="form-group col-md-12">
          ...
          <div ><input type="text" name="name" value="{{$model->name}}" class="form-control"></div>
        </div>
        ...
        <div class="form-group col-md-12">
          ...
          <div ><textarea name="description" class="form-control">{{$model->description}}</textarea> 
                 ...
                 <div class="checkbox">
                        ...
                        <div class="task-check">
                                                        <div class="col-md-12">
                                                         ...
                                                         <?php if(in_array($perm->id,$ids)):?>
                                                        <input name="permission[]" value="<?=$perm->id;?>"  type="checkbox"  checked>
                                                        <?php else:?>
