	...
	<form action="{{$url}}" method="post">
		 ...
		 <div class="row">
		 	...
		 	<input type="text" readonly  class="form-control" value="{{$nationalservice->servicenumber}}">
		 ...
		 <div class="col-md-12 form-group">
		 	<label>Reason</label>
		 	<textarea name="reason" class="form-control" required>{{$nationalservice->reason}}</textarea>
