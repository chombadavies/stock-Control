...
<!-- Mirrored from portotheme.com/html/porto-admin/3.0.0/layouts-header-menu-stripe.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Oct 2021 03:35:21 GMT -->
<head>
...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:100,300,400,600,800,900|Shadows+Into+Light" rel="stylesheet" type="text/css">
		...
		<!-- Vendor CSS -->
		<link rel="stylesheet" href="{{asset('fixed/vendor/bootstrap/css/bootstrap.css')}}" />
		<link rel="stylesheet" href="{{asset('fixed/vendor/animate/animate.css')}}">

		<link rel="stylesheet" href="{{asset('fixed/vendor/font-awesome/css/all.min.css')}}" />
		<link rel="stylesheet" href="{{asset('fixed/vendor/magnific-popup/magnific-popup.css')}}" />
		<link rel="stylesheet" href="{{asset('fixed/vendor/bootstrap-datepicker/css/bootstrap-datepicker3.css')}}" />

		<!-- Specific Page Vendor CSS -->		<link rel="stylesheet" href="{{asset('fixed/vendor/jquery-ui/jquery-ui.css')}}" />		<link rel="stylesheet" href="{{asset('fixed/vendor/jquery-ui/jquery-ui.theme.css')}}" />		<link rel="stylesheet" href="{{asset('fixed/vendor/bootstrap-multiselect/css/bootstrap-multiselect.css')}}" />		<link rel="stylesheet" href="{{asset('fixed/vendor/morris/morris.css')}}" />

		<!--(remove-empty-lines-end)-->

		<!-- Theme CSS -->
		<link rel="stylesheet" href="{{asset('fixed/css/theme.css')}}" />
		...
		<!-- Theme Custom CSS -->
		<link rel="stylesheet" href="{{asset('fixed/css/custom.css')}}">

		<!-- Head Libs -->
		<script src="{{asset('fixed/vendor/modernizr/modernizr.js')}}"></script>		<script src="{{asset('fixed/master/style-switcher/style.switcher.localstorage.js')}}"></script>
	...
	<body>
		<section class="body">
			...
			<header class="header header-nav-menu header-nav-stripe">
				<div class="logo-container">
					<a href="http://portotheme.com/html/porto-admin/" class="logo">
						<img src="{{asset('fixed/img/logo.png')}}" width="75" height="35" alt="Porto Admin" />
					</a>
				...
				<div class="header-right">
					...
					<form action="http://portotheme.com/html/porto-admin/3.0.0/pages-search-results.html" class="search nav-form d-none d-xl-inline-block">
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{asset('fixed/img/%21sample-user.jpg')}}" alt="Joseph Doe Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{asset('fixed/img/%21sample-user.jpg')}}" alt="Joseph Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{asset('fixed/img/%21sample-user.jpg')}}" alt="Joe Junior" class="rounded-circle" />
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="{{asset('fixed/img/%21logged-user.jpg')}}" alt="Joseph Doe" class="rounded-circle" data-lock-picture="img/%21logged-user.jpg" />
							</figure>
							...
							<div class="sidebar-widget widget-friends">
								...
								<ul>
									<li class="status-online">
										<figure class="profile-picture">
											<img src="{{asset('fixed/img/%21sample-user.jpg')}}" alt="Joseph Doe" class="rounded-circle">
										</figure>
										<div class="profile-info">
		...
		<!-- Vendor -->
		<script src="{{asset('fixed/vendor/jquery/jquery.js')}}"></script>		<script src="{{asset('fixed/vendor/jquery-browser-mobile/jquery.browser.mobile.js')}}"></script>		<script src="{{asset('fixed/vendor/jquery-cookie/jquery.cookie.js')}}"></script>		<script src="{{asset('fixed/master/style-switcher/style.switcher.js')}}"></script>		<script src="{{asset('fixed/vendor/popper/umd/popper.min.js')}}"></script>		<script src="{{asset('fixed/vendor/bootstrap/js/bootstrap.js')}}"></script>		<script src="{{asset('fixed/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js')}}"></script>		<script src="{{asset('fixed/vendor/common/common.js')}}"></script>		<script src="{{asset('fixed/vendor/nanoscroller/nanoscroller.js')}}"></script>		<script src="{{asset('fixed/vendor/magnific-popup/jquery.magnific-popup.js')}}"></script>		<script src="{{asset('fixed/vendor/jquery-placeholder/jquery.placeholder.js')}}"></script>
		
		<!-- Specific Page Vendor -->		<script src="{{asset('fixed/vendor/jquery-ui/jquery-ui.js')}}"></script>		<script src="{{asset('fixed/vendor/jqueryui-touch-punch/jquery.ui.touch-punch.js')}}"></script>		<script src="{{asset('fixed/vendor/jquery-appear/jquery.appear.js')}}"></script>		<script src="{{asset('fixed/vendor/bootstrap-multiselect/js/bootstrap-multiselect.js')}}"></script>		<script src="{{asset('fixed/vendor/jquery.easy-pie-chart/jquery.easypiechart.js')}}"></script>		<script src="{{asset('fixed/vendor/flot/jquery.flot.js')}}"></script>		<script src="{{asset('fixed/vendor/flot.tooltip/jquery.flot.tooltip.js')}}"></script>		<script src="{{asset('fixed/vendor/flot/jquery.flot.pie.js')}}"></script>		<script src="{{asset('fixed/vendor/flot/jquery.flot.categories.js')}}"></script>		<script src="{{asset('fixed/vendor/flot/jquery.flot.resize.js')}}"></script>		<script src="{{asset('fixed/vendor/jquery-sparkline/jquery.sparkline.js')}}"></script>		<script src="{{asset('fixed/vendor/raphael/raphael.js')}}"></script>		<script src="{{asset('fixed/vendor/morris/morris.js')}}"></script>		<script src="{{asset('fixed/vendor/gauge/gauge.js')}}"></script>		<script src="{{asset('fixed/vendor/snap.svg/snap.svg.js')}}"></script>		<script src="{{asset('fixed/vendor/liquid-meter/liquid.meter.js')}}"></script>		<script src="{{asset('fixed/vendor/jqvmap/jquery.vmap.js')}}"></script>		<script src="{{asset('fixed/vendor/jqvmap/data/jquery.vmap.sampledata.js')}}"></script>		<script src="{{asset('fixed/vendor/jqvmap/maps/jquery.vmap.world.js')}}"></script>		<script src="{{asset('fixed/vendor/jqvmap/maps/continents/jquery.vmap.africa.js')}}"></script>		<script src="{{asset('fixed/vendor/jqvmap/maps/continents/jquery.vmap.asia.js')}}"></script>		<script src="{{asset('fixed/vendor/jqvmap/maps/continents/jquery.vmap.australia.js')}}"></script>		<script src="{{asset('fixed/vendor/jqvmap/maps/continents/jquery.vmap.europe.js')}}"></script>		<script src="{{asset('fixed/vendor/jqvmap/maps/continents/jquery.vmap.north-america.js')}}"></script>		<script src="{{asset('fixed/vendor/jqvmap/maps/continents/jquery.vmap.south-america.js')}}"></script>


		<!--(remove-empty-lines-end)-->
		
		<!-- Theme Base, Components and Settings -->
		<script src="{{asset('fixed/js/theme.js')}}"></script>
		
		<!-- Theme Custom -->
		<script src="{{asset('fixed/js/custom.js')}}"></script>
		
		<!-- Theme Initialization Files -->
		<script src="{{asset('fixed/js/theme.init.js')}}"></script>
		<!-- Analytics to Track Preview Website -->		<script>		  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){		  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),		  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)		  })(window,document,'script','../../../../www.google-analytics.com/analytics.js','ga');		  ga('create', 'UA-42715764-8', 'auto');		  ga('send', 'pageview');		</script>
		<!-- Examples -->
		<script src="{{asset('fixed/js/examples/examples.header.menu.js')}}"></script>
		<script src="{{asset('fixed/js/examples/examples.dashboard.js')}}"></script>
